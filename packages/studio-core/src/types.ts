...
export type StudioCommand =
  ...
  | StudioRemoveNodeCommand
  | StudioMoveNodeCommand
  | StudioPatchNodeCommand
  | StudioWrapNodeCommand
  | StudioUnwrapNodeCommand
  | StudioAddVariantOpCommand
  | StudioReplaceVariantCommand
  | StudioRemoveVariantCommand
  | StudioAddAcceptanceCommand;
...
export interface StudioAdapters<VariantRef = unknown, SourceMap = unknown> {
  ...
  buildSourceMap?: (
    ...
    options: { entryFile?: string; variantRefs?: VariantRef[] },
  ) => SourceMap;
}
